...
export const fetchBookmark = createAction('[Image Finder] Fetch Bookmark', props<{ id: string }>());
export const fetchBookmarkSuccess = createAction('[Image Finder] Fetch Success Bookmark', props<{ item: Image }>());
export const fetchBookmarkFailure = createAction('[Image Finder] Fetch Failure Bookmark', props<{ error: any }>());
export const addBookmark = createAction('[Image Finder] Add Bookmark', props<{item: Image}>());
